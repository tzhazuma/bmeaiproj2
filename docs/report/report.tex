...
\midrule
SegFormer-B0 (LoRA)    & 4.2M  & 461K  & 0.678 & \textbf{0.687} & \textbf{0.689} & \textbf{0.685} \\
SwinUNETR2D (scratch)  & 6.9M  & 6.9M  & \textbf{0.684} & 0.540 & 0.678 & 0.634 \\
...
\bottomrule
\end{tabular}
\caption{Final pretrained model fine-tuning results. SegFormer-B0 with LoRA achieves the best overall performance (mean Dice 0.685) with only 461K trainable parameters (11\% of model). SwinUNETR2D leads on WT. All models trained for 10–15 epochs on 30 BraTS cases with bf16 AMP.}
