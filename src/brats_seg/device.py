...
Usage::
    ...
    dev = get_device()          # e.g. "cuda", "mps", "xpu", "cpu"
...
def get_device() -> str:
    ...
    1. CUDA (NVIDIA GPU, also covers AMD ROCm via PyTorch ROCm builds)
...
def device_type() -> str:
    ...
    dev = get_device()
    return "gpu" if dev in ("cuda", "xpu") else dev  # mps is also "gpu"
